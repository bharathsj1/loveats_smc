...
class TravelCardListState extends State<TravelCardList>
  ...
  Widget build(BuildContext context) {
    ...
    _cardHeight = (size.height * .35).clamp(300.0, 400.0);
    _cardWidth = size.width * 0.86;
      ...
      onTap: () {
        ...
        Navigator.pushNamed(
          ...
          arguments: RestaurantDetails(
              imagePath: widget.cities[itemIndex].restImage,
              restaurantName: widget.cities[itemIndex].restName,
              restaurantAddress: widget.cities[itemIndex].restAddress +
                  widget.cities[itemIndex].restCity +
                  ' ' +
                  widget.cities[itemIndex].restCountry,
              rating: '0.0',
              category: widget.cities[itemIndex].restType,
              distance: '0 Km',
              data: widget.cities[itemIndex]),
        );
      },
      child: Container(
        child: Rotation3d(
