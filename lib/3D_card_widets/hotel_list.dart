...
class _HotelListViewState extends State<HotelList> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      opacity: _anim.value,
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: Styless.hzScreenPadding * 1.5, vertical: 10),
        child: Container(
          width: 400,
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Hotels'.toUpperCase(), style: Styless.hotelsTitleSection),
              Expanded(
                child: Column(
    ...
    return Row(
      ...
      children: <Widget>[
        Column(
          ...
          children: <Widget>[
            Text(hotel.name, style: Styless.hotelTitle),
            SizedBox(height: 3),
            Row(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(hotel.rate.toString(), style: Styless.hotelScore),
                ),
                Text('(${hotel.reviews})', style: Styless.hotelData),
              ],
            )
          ],
        ),
