...
class Styless {
  ...
  static final TextStyle baseTitle = TextStyle(fontSize: 11, fontFamily: 'DMSerifDisplay', package: 'potbelly');
  static final TextStyle baseBody = TextStyle(fontSize: 11, fontFamily: 'OpenSans', package: 'potbelly');
