...
import 'Herostyles.dart';

class CityScenery extends StatelessWidget {
  final double animationValue;
  final RestaurantDetails city;
  ...
  //             child: Text(city['resname'], style: HeroStyles.cardTitle),
  //           ),
  //           Text(city.description, textAlign: TextAlign.center, style: HeroStyles.cardSubtitle),
  //           Padding(
  //             padding: const EdgeInsets.symmetric(vertical: 12.0),
  //             child: Text('Learn More'.toUpperCase(), style: HeroStyles.cardAction),
  //           )
  //         ],
  //       ),
  //     ),
  ...
  Widget _buildBackgroundTransition(Animation animation) {
    var gradientStart =
        ColorTween(begin: Color(0xffdaf3f7), end: Color(0xFFfde9c8)).animate(CurvedAnimation(curve: Curves.easeOut, parent: animation));
    var gradientEnd = ColorTween(begin: Color(0xffdaf3f7), end: Color(0xFFfdf8f1)).evaluate(animation);
    var borderRadiusAnimation = Tween<double>(begin: HeroStyles.cardBorderRadius, end: 0).transform(animationValue);
    return Container(
    ...
    return Stack(
      children: <Widget>[
        Positioned(
          ...
          child: Image.asset(
            'assets/hero_card/CloudLarge.png',
        ...
        Positioned(
          ...
          left: dxPosition * .5,
          child: Image.asset(
            'assets/hero_card/CloudSmall.png',
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      child: Rotation3d(
          ...
          child: Image.asset(
            'assets/hero_card/BlowingLeaf.png',
      ...
      children: <Widget>[
        Container(
            ...
            child: Stack(
              alignment: Alignment.bottomCenter,
              children: <Widget>[
                // Image.asset('assets/hero_card/Paris/Paris-Back.png',),
                Image.asset('assets/demo_card/Budapest/Budapest-Back.png',),
                // Image.asset('assets/hero_card/Paris/Paris-Middle.png',),
                Image.asset('assets/demo_card/Budapest/Budapest-Middle.png',),
                // Image.asset('assets/hero_card/Paris/Paris-Front.png',),
                Image.asset('assets/demo_card/Budapest/Budapest-Front.png',width: MediaQuery.of(context).size.width*0.8,),
              ],
            )),
        Image.asset('assets/hero_card/Ground.png', width: size.width,)
      ],
    );
  }
}
