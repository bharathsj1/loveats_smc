...
class _TravelCardDemoState extends State<TravelCardDemo> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: Styless.hzScreenPadding),
              child: Text(
                'Where are you going next?',
                overflow: TextOverflow.ellipsis,
                style: Styless.appHeader,
                maxLines: 2,
              ),
            ),
            TravelCardList(
  ...
  Widget _buildAppBar() {
    return AppBar(
      ...
      actions: <Widget>[
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: Styless.hzScreenPadding),
