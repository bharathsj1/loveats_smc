...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen>
  ...
  bottomSheetforaddcart(BuildContext context, items) {
    var itemqty = '1';
    return showModalBottomSheet(
        context: context,
        isScrollControlled: true,
          ...
          return StatefulBuilder(builder: (BuildContext context,
            ...
            return Container(
              ...
              child: Column(
                ...
                items['cart'] !=null && items['cart']?    Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 15.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                          ...
                          children: <Widget>[
                            ...
                            PotbellyButton(
                              ...
                              onTap: () async {
                                ...
                                Map<String, dynamic> cartdata = {
                                  'id': items['id'],
                                  'restaurantId': items['rest_id'],
                                  'image': items['menu_image'],
                                  'details': items['menu_details'],
                                  'name': items['menu_name'],
                                  'price': double.parse(items['menu_price']),
                                  'payableAmount':
                                      items['menu_price'].toString(),
                                  'qty': itemqty,
                                  'data': items,
