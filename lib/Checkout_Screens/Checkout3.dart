  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: widget.checkoutdata['type'] == 'subscription'
            ? null
            : Text(
                'Checkout (3/3)',
      ...
      body: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            widget.checkoutdata['type'] == 'subscription'
                ? Container()
                : Material(
                    elevation: 0.5,
                    child: Container(
            ...
            widget.checkoutdata['type'] == 'subscription'
                ? Center(child: Image.asset('assets/images/congras.gif'))
                : Image.asset('assets/images/cooking.gif'),
            SizedBox(
              height: 35,
            ),
            Center(
            ...
            Center(
              child: Padding(
                ...
                child: Text(
                    widget.checkoutdata['type'] == 'subscription'
                        ? 'Congratulations! Subscription has been activated to your account, Enjoy! '
                ...
                PotbellyButton(
                  ...
                  onTap: () {
                    Navigator.pushNamedAndRemoveUntil(
                        context, AppRouter.rootScreen, (route) => false);
                  },
                  buttonHeight: 45,
