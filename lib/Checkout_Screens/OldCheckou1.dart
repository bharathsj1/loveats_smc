...
class OldCheckOutScreen1 extends StatefulWidget {
  var checkoutdata;
  OldCheckOutScreen1({@required this.checkoutdata});

  @override
  _OldCheckOutScreen1State createState() => _OldCheckOutScreen1State();
}

class _OldCheckOutScreen1State extends State<OldCheckOutScreen1> {
  int page = 1;
